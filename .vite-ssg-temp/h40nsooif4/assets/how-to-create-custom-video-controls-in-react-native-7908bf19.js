...
const meta = [{ "property": "og:title", "content": "How to Create Custom Video Controls in React Native" }, { "name": "twitter:title", "content": "How to Create Custom Video Controls in React Native" }, { "name": "description", "content": "This is a test" }, { "property": "og:description", "content": "This is a test" }, { "name": "twitter:description", "content": "This is a test" }];
const _sfc_main = {
  __name: "how-to-create-custom-video-controls-in-react-native",
  __ssrInlineRender: true,
  setup(__props, { expose: __expose }) {
    const frontmatter = { "title": "How to Create Custom Video Controls in React Native", "description": "This is a test", "datePublished": "2020-12-18T00:00:00.000Z", "dateUpdated": "2023-09-17T00:00:00.000Z", "meta": [{ "property": "og:title", "content": "How to Create Custom Video Controls in React Native" }, { "name": "twitter:title", "content": "How to Create Custom Video Controls in React Native" }, { "name": "description", "content": "This is a test" }, { "property": "og:description", "content": "This is a test" }, { "name": "twitter:description", "content": "This is a test" }] };
    __expose({ frontmatter });
    const head = { "title": "How to Create Custom Video Controls in React Native", "meta": [{ "property": "og:title", "content": "How to Create Custom Video Controls in React Native" }, { "name": "twitter:title", "content": "How to Create Custom Video Controls in React Native" }, { "name": "description", "content": "This is a test" }, { "property": "og:description", "content": "This is a test" }, { "name": "twitter:description", "content": "This is a test" }] };
    vue.useHead(head);
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.ssrRenderComponent(_component_CoreMdWrapper, vue$1.mergeProps({ frontmatter }, _attrs), {
        default: vue$1.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="markdown-body"${_scopeId}><p${_scopeId}>Videos are an extremely common way for users to consume information. On average there are 1 million video views per day on YouTube, and everyone has a Netflix subscription.</p><p${_scopeId}>Video controls have a huge impact on the viewing experience. They can make or break an app so it’s important to get it right. You can’t just rely on the native controls because it might not fit the theme of your app and you can’t guarantee that the user experience is uniform between devices. The only option is to create your own and I will show you how to do just that.</p><h2${_scopeId}>Requirements</h2><p${_scopeId}>You should be familiar with JavaScript and have some basic knowledge of React and React Native. I am going to be using Expo to initialize the app and I’ll be using their <a href="https://docs.expo.io/versions/latest/sdk/video/"${_scopeId}>Video</a> component. I am running this code on my iOS device using the Expo app. The same general principles should apply if you want to use a base React Native build with React Native Video. Of course the methods will probably be a bit different so be sure to read up on their documentation.</p><h2${_scopeId}>Setting Up</h2><p${_scopeId}>To begin let’s create a new app with the <code class="hljs"${_scopeId}>expo-<span class="hljs-keyword"${_scopeId}>cli</span></code>:</p><p${_scopeId}><code class="hljs"${_scopeId}>expo <span class="hljs-keyword"${_scopeId}>init</span> custom-video-controls</code></p><p${_scopeId}>Select Bare from the JavaScript managed workflow.</p><p${_scopeId}>Once the app is created, navigate into the base directory and install expo-av and React Native Elements.</p><p${_scopeId}><code class="hljs"${_scopeId}>expo install expo-av react-<span class="hljs-keyword"${_scopeId}>native</span>-elements</code></p><p${_scopeId}>Expo AV is a package provided by Expo that gives us access to their Video and Audio components. React Native Elements is a component library that will allow us to easily create some customizable controls.</p><p${_scopeId}>Once that finishes installing open App.js and the code with this:</p><pre${_scopeId}><code class="hljs language-jsx"${_scopeId}><span class="hljs-keyword"${_scopeId}>import</span> <span class="hljs-title class_"${_scopeId}>React</span> <span class="hljs-keyword"${_scopeId}>from</span> <span class="hljs-string"${_scopeId}>&#39;react&#39;</span>;
...
</code></pre><h2${_scopeId}>Conclusion</h2><p${_scopeId}>That wraps up this tutorial on custom video controls in React Native. Obviously, this could still use a bit of styling but that should be easy to implement now that we actually have some functional controls. You can utilize other methods provided by expo video to add additional functionality to your controls.</p><p${_scopeId}>Thanks for reading and feel free to follow me on Twitter to stay up to date with my posts!</p></div>`);
          } else {
            return [
              vue$1.createVNode("div", { class: "markdown-body" }, [
                ...
                vue$1.createVNode("h2", null, "Requirements"),
                vue$1.createVNode("p", null, [
                  ...
                  vue$1.createVNode("a", { href: "https://docs.expo.io/versions/latest/sdk/video/" }, "Video"),
                ...
                vue$1.createVNode("h2", null, "Setting Up"),
                vue$1.createVNode("p", null, [
                ...
                vue$1.createVNode("h2", null, "Playing and Pausing"),
                ...
                vue$1.createVNode("h2", null, "Skipping Forward and Backward"),
                ...
                vue$1.createVNode("h2", null, "Creating the Duration Bar"),
                ...
                vue$1.createVNode("h2", null, "Conclusion"),
