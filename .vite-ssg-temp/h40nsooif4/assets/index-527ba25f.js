    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.ssrRenderComponent(_component_RouterLink, vue.mergeProps({
        ...
        default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<li class="rounded-lg transition-colors pa-1 @hover:bg-gray @hover:bg-op-7"${_scopeId}><h5 class="ma-none"${_scopeId}>${serverRenderer.ssrInterpolate(_ctx.post.title)} - `);
            ...
            return [
              vue.createVNode("li", { class: "rounded-lg transition-colors pa-1 @hover:bg-gray @hover:bg-op-7" }, [
...
const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="flex items-center"><label class="invisible ma-0 block h-0 w-0 pa-0" for="search"> Search </label><div class="i-ph-magnifying-glass mr-2"></div><input id="search"${serverRenderer.ssrRenderAttr("value", vue.unref(search))} class="dark:bg-dark-700 w-full outline-none"${serverRenderer.ssrRenderAttr("placeholder", _ctx.placeholder)}></div></div>`);
    };
  }
});
