...
const _sfc_main$6 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${serverRenderer.ssrRenderAttrs(vue.mergeProps({ class: "max-w-full w-full flex items-center px-4 text-sm prose" }, _attrs))}><p class="op-70 dark:op-50"> © ${serverRenderer.ssrInterpolate(vue.unref(dayjs)().format("YYYY"))} <a xmlns:cc="http://creativecommons.org/ns#" href="freedomevenden.com" property="cc:attributionName" rel="cc:attributionURL">${serverRenderer.ssrInterpolate(" ")} Freedom Evenden ${serverRenderer.ssrInterpolate(" ")}</a> - <span xmlns:dct="http://purl.org/dc/terms/" property="dct:title"> Website text and images </span> are licensed under <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"> CC-BY-NC-SA-4.0 </a> . </p></footer>`);
    };
  }
});
...
const __pages_import_0__ = () => Promise.resolve().then(() => require("./assets/index-641a0f11.js"));
